...
// TODO
+(void)addDataWithCompletion:(void(^)(BOOL success ,id entity))completion;
...
// TODO
-(void)updateDataWithCompletion:(void(^)(BOOL success ,id entity))completion;
/* 4, 定義搜尋資料 static 方法 getDataResultsWithCompletion:(?) completion; 其中「?」為 void block 參數：NSArray *results */
// TODO
+(void)getDataResultsWithCompletion:(void(^)(NSArray *results))completion;
@end
